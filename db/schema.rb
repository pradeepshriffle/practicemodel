...
ActiveRecord::Schema[7.0].define(version: 2023_08_16_025237) do
  ...
  create_table "profiles", force: :cascade do |t|
    t.integer "us_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["us_id"], name: "index_profiles_on_us_id"
  end
  ...
  add_foreign_key "profiles", "us", column: "us_id"
